...
const mutateParticipantUpdate = (state, participantId) => {
...
const mutateParticipantList = (state, newParticipant) => {
  state.participants.push(newParticipant);
};
const mutateParticipantAddAppointment = (state, addAppoint) => {
...
const mutateParticipantDelete = (state, code) => {
...
export default {
  ...
  mutateLookedAgenda,
  mutateupdateAgenda,
  mutateParticipantUpdate,
  mutateParticipantList,
  mutateParticipantAddAppointment,
  mutateParticipantDelete,
